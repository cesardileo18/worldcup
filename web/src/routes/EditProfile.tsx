...
export const EditProfile = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    if (ownedLeagues.length > 0) {
      ...
      showToast(
        `Primero debes eliminar o transferir la propiedad de tus ligas: ${leagueNames}`,
        'error'
      );
      return;
    }
    ...
    const confirmed = await showConfirm({
      ...
      message:
        '¿Seguro que quieres eliminar tu cuenta de forma permanente? Esto borrará todos tus datos, pronósticos y membresías en ligas. Esta acción no se puede deshacer.',
